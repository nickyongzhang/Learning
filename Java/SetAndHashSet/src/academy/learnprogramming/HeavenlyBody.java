...
//    public static final int ASTEROID = 6;
    ...
    public Set<HeavenlyBody> getSatellites() {
        return new HashSet<>(satellites); // create a copy so method calling this cannot change the class field
    }

    @Override
    public final boolean equals(Object obj) { // if input is HeavenlyBody, the function becomes overloading rather than overriding
